  ...
  return (
    <div className={className}>
      ...
      <div className="space-y-6">
        {/* Main Privacy Card */}
        <Card className="border-2 border-[var(--color-primary)] bg-[var(--color-primary-bkg)]">
          <CardContent className="pt-8 pb-8">
            <div className="flex items-start gap-4 mb-6">
              <div className="flex-shrink-0 w-12 h-12 rounded-full flex items-center justify-center bg-[var(--color-primary)] text-white">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                </svg>
              </div>
              <div className="flex-1">
                <h2 className="text-xl font-semibold text-[var(--text-main)] mb-2">100% Local Storage</h2>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <Card>
            <CardContent className="pt-6 pb-6">
              <div className="flex items-start gap-3 mb-4">
                <div className="flex-shrink-0 w-10 h-10 bg-green-500/10 rounded-lg flex items-center justify-center text-green-500">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                </div>
                <div>
                  <h3 className="font-semibold text-[var(--text-main)] mb-2">No Server, No Cloud</h3>
          ...
          <Card>
            <CardContent className="pt-6 pb-6">
              <div className="flex items-start gap-3 mb-4">
                ...
                <div>
                  <h3 className="font-semibold text-[var(--text-main)] mb-2">No Synchronization</h3>
                  <p className="text-sm text-[var(--text-muted)] leading-relaxed">
          ...
          <Card>
            <CardContent className="pt-6 pb-6">
              <div className="flex items-start gap-3 mb-4">
                <div className="flex-shrink-0 w-10 h-10 bg-purple-500/10 rounded-lg flex items-center justify-center text-purple-500">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                  </svg>
                </div>
                <div>
                  <h3 className="font-semibold text-[var(--text-main)] mb-2">Complete Privacy</h3>
                  <p className="text-sm text-[var(--text-muted)] leading-relaxed">
          ...
          <Card>
            <CardContent className="pt-6 pb-6">
              <div className="flex items-start gap-3 mb-4">
                <div className="flex-shrink-0 w-10 h-10 bg-orange-500/10 rounded-lg flex items-center justify-center text-orange-500">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                  </svg>
                </div>
                <div>
                  <h3 className="font-semibold text-[var(--text-main)] mb-2">You Control Your Data</h3>
                  <p className="text-sm text-[var(--text-muted)] leading-relaxed">
        ...
        <Card>
          <CardContent className="pt-6 pb-6">
            <h3 className="font-semibold text-[var(--text-main)] mb-4">How It Works</h3>
            <div className="space-y-3 text-sm text-[var(--text-muted)]">
              <div className="flex items-start gap-3">
                <span className="flex-shrink-0 w-6 h-6 bg-[var(--bg-main)] rounded-full flex items-center justify-center text-xs font-semibold text-[var(--text-main)]">1</span>
                <p>
                  <strong className="text-[var(--text-main)]">Browser Storage:</strong> All data is stored using IndexedDB,
                  a modern browser database technology that provides fast, reliable local storage.
                </p>
              </div>
              <div className="flex items-start gap-3">
                <span className="flex-shrink-0 w-6 h-6 bg-[var(--bg-main)] rounded-full flex items-center justify-center text-xs font-semibold text-[var(--text-main)]">2</span>
                <p>
                  <strong className="text-[var(--text-main)]">No Network Required:</strong> The application works completely offline.
                  Once loaded, you can use it without an internet connection.
                </p>
              </div>
              <div className="flex items-start gap-3">
                <span className="flex-shrink-0 w-6 h-6 bg-[var(--bg-main)] rounded-full flex items-center justify-center text-xs font-semibold text-[var(--text-main)]">3</span>
                <p>
                  <strong className="text-[var(--text-main)]">Device-Specific:</strong> Data is tied to your browser and device.
        ...
        {/* Important Notes */}
        <Card className="border-[var(--border-color)] bg-[var(--bg-card)]">
          <CardContent className="pt-6 pb-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-semibold text-[var(--text-main)] mb-2">Important Notes</h3>
        ...
        <Card>
          <CardContent className="pt-6 pb-6">
            <h3 className="font-semibold text-[var(--text-main)] mb-4">Terms of Use</h3>
